...
class SettingController extends AdminBaseController
{
    ...
    public function site()
    {
        ...
        $this->assign("wx", $wx_setting);
        $this->assign("sms_setting", $sms_setting);
        $this->assign("present_manage", $present_manage);
    ...
    public function sitePost()
    {
        if ($this->request->isPost()) {
            ...
            // ------通用设置  微信
            $wx_settings=$this->request->param('wx/a');
            cmf_set_option('wx',$wx_settings);
            // 短信
            $sms_settings=$this->request->param('sms_settings/a');
            cmf_set_option('sms_setting',$sms_settings);

            $present_manage=$this->request->param('present_manage/a');
            cmf_set_option('present_manage',$present_manage);
            // 运费
            $freight_setting     = $this->request->param('freight_setting/a');//运费
            cmf_set_option('freight_setting',$freight_setting);
