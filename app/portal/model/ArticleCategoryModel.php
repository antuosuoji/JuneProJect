...
//        }
        ...
        foreach ($categories as $item) {
            ...
            $item['str_action'] = '<a href="' . url("AdminArticleCategory/add", ["parent" => $item['id']]) . '">添加子分类</a>  <a href="' . url("AdminArticleCategory/edit", ["id" => $item['id']]) . '">' . lang('EDIT') . '</a>  <a class="js-ajax-delete" href="' . url("AdminArticleCategory/delete", ["id" => $item['id']]) . '">' . lang('DELETE') . '</a> ';
            array_push($newCategories, $item);
        }
